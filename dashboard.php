            ...
            <nav id="sidebar">
               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li>
                        <a href="#apps" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-object-group blue2_color"></i> <span>Actions</span></a>
                        <ul class="collapse list-unstyled" id="apps">
                           <li><a href="addclients.php">> <span>add client</span></a></li>
                           <li><a href="calendar.html">> <span>Calendar</span></a></li>
                           <li><a href="tables.php">> <span>clients</span></a></li>
                     ...
                     <div class="row column1">
                        <div class="col-md-6 col-lg-3">
                           <div class="full counter_section margin_bottom_30">
                              ...
                              <div class="counter_no">
                                 <div>
                                    <p class="total_no">120</p>
                                    <p class="head_couter">Total Clients</p>
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="col-md-6 col-lg-3">
                              <div class="full counter_section margin_bottom_30">
                                 ...
                                 <div class="counter_no">
                                       <div>
                                          <p class="total_no">KES 123.50</p>
                                          <p class="head_couter">Commission update</p>
                                       </div>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="full counter_section margin_bottom_30">
                              <div class="couter_icon">
                                    <div> 
                                       <i class="fa fa-chart-pie green_color"></i>
                                    </div>
                              </div>
                              <div class="counter_no">
                                    <div>
                              ...
                              <div class="dash_blog_inner">
                                 <div class="dash_head">
                                    ...
                                    <?php
                                       ...
                                       ?> 
                                 </span><span class="plus_green_bt"><a href="#">+</a></span></h3>
                                 </div>
                                 <div class="list_cont">
                                    <p>Upcoming Marketing routes for <?php echo $full_name; ?> </p>
                                 </div>
                                 <div class="task_list_main">
                                    <ul class="task_list">
                                       <li><a href="#">route 1</a><br><strong></strong></li>
                                       <li><a href="#">route 2</a><br><strong></strong></li>
                                 ...
                                 <div class="msg_list_main">
                                    <ul class="msg_list">
                                       <li>
                                          ...
                                          <span class="msg_user">messages.</span>
